...
function Checkout(props) {
  ...
  const [first_name, setFirstName] = useState("Hello Me");
  const [last_name, setLastName] = useState("Hello Me");
  const [email, setEmail] = useState("admin2@gmail.com");
  const [phone, setPhone] = useState("0123123123");
  const [address, setAddress] = useState("Hello Me");
          ...
          <Form.Group>
            ...
            <Row>
              <Col
                ...
                onClick={(e) => changeActivePayment(e)}
              >
          ...
          <Form.Group style={{ paddingTop: "20px" }}>
            ...
            <Row>
              <Col
                ...
                data-value="Free"
                onClick={(e) => changeActiveShipping(e)}
              >
                <div className="free ">
                  <div>
        ...
        <div className="bill_detail">
          ...
          <div className="order_sumary">
            ...
            >
              <span>{shipping}</span>
              <span>
                {shippingCost[shipping] ? shippingCost[shipping] : 0}$
              </span>
            </div>
            <div style={{ textAlign: "right", paddingTop: "5px" }}>
              <span>
